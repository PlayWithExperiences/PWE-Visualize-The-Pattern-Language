import {groupFor,encodeAtlas} from './atlas/compose.js?v=580c78464447';
import {patterns, SOURCE} from './data/patterns.js?v=580c78464447';
import {normalize, defaults, encode, decode, buildScene} from './model.js?v=580c78464447';
import {renderScene} from './scene.js?v=580c78464447';
import {createWalk} from './walk.js?v=580c78464447';
import {normalizeSun,sampleSun,formatHour} from './sun.js?v=580c78464447';
...
async function loadCatalog(){
 try{const res=await fetch('./data/catalog.json?v=580c78464447');if(!res.ok)throw Error('HTTP '+res.status);catalog=await res.json();if(catalog.length!==253)throw Error('目录数量异常');catalogRender();detail();}
