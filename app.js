import {groupFor,encodeAtlas} from './atlas/compose.js?v=3534622f64ec';
import {patterns, SOURCE} from './data/patterns.js?v=3534622f64ec';
import {normalize, defaults, encode, decode, buildScene} from './model.js?v=3534622f64ec';
import {renderScene} from './scene.js?v=3534622f64ec';
import {createWalk} from './walk.js?v=3534622f64ec';
import {normalizeSun,sampleSun,formatHour} from './sun.js?v=3534622f64ec';
...
async function loadCatalog(){
 try{const res=await fetch('./data/catalog.json?v=3534622f64ec');if(!res.ok)throw Error('HTTP '+res.status);catalog=await res.json();if(catalog.length!==253)throw Error('目录数量异常');catalogRender();detail();}
