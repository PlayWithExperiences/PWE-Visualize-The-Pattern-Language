import {groupFor,encodeAtlas} from './atlas/compose.js?v=b6146c2fbb37';
import {patterns, SOURCE} from './data/patterns.js?v=b6146c2fbb37';
import {normalize, defaults, encode, decode, buildScene} from './model.js?v=b6146c2fbb37';
import {renderScene} from './scene.js?v=b6146c2fbb37';
import {createWalk} from './walk.js?v=b6146c2fbb37';
import {normalizeSun,sampleSun,formatHour} from './sun.js?v=b6146c2fbb37';
...
async function loadCatalog(){
 try{const res=await fetch('./data/catalog.json?v=b6146c2fbb37');if(!res.ok)throw Error('HTTP '+res.status);catalog=await res.json();if(catalog.length!==253)throw Error('目录数量异常');catalogRender();detail();}
