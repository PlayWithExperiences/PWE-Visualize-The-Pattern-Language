import {groupFor,encodeAtlas} from './atlas/compose.js?v=a08df7453e28';
import {patterns, SOURCE} from './data/patterns.js?v=a08df7453e28';
import {normalize, defaults, encode, decode, buildScene} from './model.js?v=a08df7453e28';
import {renderScene} from './scene.js?v=a08df7453e28';
import {createWalk} from './walk.js?v=a08df7453e28';
import {normalizeSun,sampleSun,formatHour} from './sun.js?v=a08df7453e28';
...
async function loadCatalog(){
 try{const res=await fetch('./data/catalog.json?v=a08df7453e28');if(!res.ok)throw Error('HTTP '+res.status);catalog=await res.json();if(catalog.length!==253)throw Error('目录数量异常');catalogRender();detail();}
