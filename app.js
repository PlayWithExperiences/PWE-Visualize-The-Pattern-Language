import {groupFor,encodeAtlas} from './atlas/compose.js?v=77ac9ca8ff67';
import {patterns, SOURCE} from './data/patterns.js?v=77ac9ca8ff67';
import {normalize, defaults, encode, decode, buildScene} from './model.js?v=77ac9ca8ff67';
import {renderScene} from './scene.js?v=77ac9ca8ff67';
import {createWalk} from './walk.js?v=77ac9ca8ff67';
import {normalizeSun,sampleSun,formatHour} from './sun.js?v=77ac9ca8ff67';
...
async function loadCatalog(){
 try{const res=await fetch('./data/catalog.json?v=77ac9ca8ff67');if(!res.ok)throw Error('HTTP '+res.status);catalog=await res.json();if(catalog.length!==253)throw Error('目录数量异常');catalogRender();detail();}
