import {colors as C,gateway,route,pane} from './primitives.js?v=b6146c2fbb37';
export function plan(d){
 ...
 d.rect(130,120,720,360,C.building);const privateX=670,commonX=H(129)?440:425,commonY=H(128)?305:230;
 d.rect(commonX-110,commonY-70,220,145,C.warm,H(129)?129:H(128)?128:0,(H(139)||H(147))?'':'共享起居');
 if(!H(136))d.rect(privateX,145,150,125,C.paper,H(127)?127:0,H(138)?'':'私人领域');gateway(d,500,490,0,'主要入口');
 ...
 if(H(135)){for(const [x,y,r]of [[500,470,32],[570,325,30],[250,170,25]]){d.circle(x,y,r,'#efd29e',135,'',{'fill-opacity':.28,stroke:'none'});d.circle(x,y,r*.3,'#f6e8c9',135,'',{'fill-opacity':.4,stroke:'none'});}d.rect(340,405,85,22,'#a4aa99',135);}
 if(H(136)){d.rect(645,130,190,150,C.paper,136);d.text(740,157,'伴侣领域',136);if(!H(138))d.rect(682,180,90,55,C.warm,136);d.line(645,267,645,300,136,{width:6});}
 ...
 if(H(141))for(const x of [650,750]){d.rect(x,300,78,70,C.paper,141);d.text(x+39,358,'个人',141);d.rect(x+10,315,35,20,C.active,141);}
 ...
 if(H(156)){d.rect(170,380,110,70,C.warm,156);d.text(225,445,'个人工作',156,11);d.rect(180,390,28,42,C.active,156);d.rect(225,390,40,42,'none',156,'',{'stroke-dasharray':'4 3'});}
