...
await mkdir('dist');
for(const name of ['index.html','home.html','atlas.css','atlas-app.js','atlas','world','style.css','app.js','model.js','scene.js','walk.js','render-buffers.js','lighting.js','sun.js','free-camera.js','walk-physics.js','data']){
