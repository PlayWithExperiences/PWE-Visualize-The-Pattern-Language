...
export function buildInstitutionPattern(ctx){const {w,id,x,y,box,path,room,house,tree,bench,table,pergola,slab,gate,station,garden}=kit(ctx);
 ...
 switch(id){
 case 75: for(const [a,b]of [[1,1],[19,1],[19,18]]){room(a,b,8,7);bed(a+1,b+1);}pergola(1,17,9,9);table(2,19,3);box(2,23,0,3,.8,.9,P.wood,'shared-kitchen');path([[5,12],[15,12],[15,27],[23,27],[23,25]],2);break;
 ...
 case 90: room(1,1,9,22,{sideDoor:true});for(const b of [3,10,18]){table(2,b);bench(7,b);}path([[5.5,2],[5.5,24]],1.6,P.warm);path([[5.5,12],[13,12]],1.5,P.warm);box(7,20,0,2,2,.3,P.wood,'music-alcove');break;
 case 91: for(const [a,b]of [[1,1],[19,1],[19,18]]){room(a,b,8,7);bed(a+1,b+1);}room(1,17,9,9);table(2,19,3);chairs(2,21);path([[5,13],[15,13],[15,27],[23,27],[23,25]],2);break;
